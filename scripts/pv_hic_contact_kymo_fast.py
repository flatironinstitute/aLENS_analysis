...
proteinpvtppvdDisplay = GetDisplayProperties(
    proteinpvtppvd, view=renderView1)
...
SaveAnimation(
    str(work_dir / 'analysis/pv_flexible_filament_state.avi'), layout1, FrameRate=3, FrameWindow=[1, 6])
